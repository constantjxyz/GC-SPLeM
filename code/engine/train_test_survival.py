...
from model.model_mtMCAT_survival import MTMCAT
from model.model_mtMCAT_survival_noco import MTMCAT_noco
...
def train_survival(train_dataset, val_dataset, test_dataset, params=dict(), val=True):
    ...
    if 'co_attention' in params.keys() and params['co_attention'] == 'False':
        model = MTMCAT_noco(params=params)
    else:
    ...
    for epoch in range(1, epochs+1):
        ...
        # elif  ((val_loss - best_val_loss) / best_val_loss) < 0.05 and (epoch - best_epoch) > 10 and epoch > 10:
